...
import LeftSide from '@/containers/Kontak/LeftSide';
import RightSide from '@/containers/Kontak/RightSide';

export default function kontak() {
	return (
		<main>
			<Banner name="Kontak" link="/kontak" />
			<div className="flex flex-row w-full px-[108px] py-12 text-gray-800 gap-10 h-fit">
				<LeftSide />
				<RightSide />
			</div>
